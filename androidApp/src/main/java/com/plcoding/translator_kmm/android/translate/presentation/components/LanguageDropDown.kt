...
import com.plcoding.translator_kmm.android.R as AndroidR
    ...
    Box(modifier) {
        ...
        Row(
            ...
            Icon(
                ...
                contentDescription = if (isOpen) stringResource(AndroidR.string.close) else stringResource(AndroidR.string.open),
                tint = LightBlue,
                modifier = Modifier.size(30.dp)
            )
        }
